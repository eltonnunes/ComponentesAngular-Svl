...
! function (a, b) {
    ...
    // LOCALES
    var ke = /D[oD]?(\[[^\[\]]*\]|\s)+MMMM?/,
        le = "Janeiro_Fevereiro_Março_Abril_Maio_Junho_Julho_Agosto_Setembro_Outubro_Novembro_Dezembro".split("_"),
        me = "Jan_Fev_Mar_Abr_Mai_Jun_Jul_Ago_Set_Out_Nov_Dez".split("_"),
        ne = Zd,
        oe = Zd;
    // FORMATTING
    U("Y", 0, 0, function () {
    ...
    // LOCALES
    var re = "Domingo_Segunda-feira_Terça-feira_Quarta-feira_Quinta-feira_Sexta-feira_Sábado".split("_"),
        se = "Dom_Seg_Ter_Qua_Qui_Sex_Sáb".split("_"),
        te = "D_S_T_Q_Q_S_S".split("_"),
        ue = Zd,
        ve = Zd,
        we = Zd;
